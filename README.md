...
13. **update_note_function.py**  
    Добавлена функция update_note, вызываемая по команде update, обновление существующих саметок, отдельно по категориям.
...
4. Итоговая работа собрана и выводится в `update_note_function.py`.
